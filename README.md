...
<div class="sparkle" style="left:35%; animation-delay:2s;"></div>
<div class="sparkle" style="left:60%; animation-delay:4s;"></div>
<div class="sparkle" style="left:85%; animation-delay:1s;"></div>

<!-- Bats -->
<div class="bat" style="top:25%;">🦇</div>
<div class="bat" style="top:55%; animation-delay:5s;">🦇</div>

<header>
  <!-- LOGO FILE MUST BE NAMED logo.png -->
  <img src="logo.png" alt="Nadine’s Ghoul Lab Logo">
  <h1>Nadine’s Ghoul Lab</h1>
  <p>Frightfully Fab Doll Restoration & Custom Accessories</p>
</header>

<section>
  <h2>🦇 About the Ghoul Lab</h2>
  <p>
    Nadine’s Ghoul Lab specializes in doll hair restoration and custom 3D resin
    accessories inspired by gothic fashion dolls. Every ghoul deserves a second
    life—and a killer look.
  </p>
</section>
...
<section>
  ...
  <div class="cards">
    <div class="card">
      ...
      <p>💸 $35 – $120+</p>
      <p>Condition and styling complexity determine final quote.</p>
    </div>
    <div class="card">
      <h3>Reroots</h3>
      <p>💸 $60 – $180+</p>
      <p>Fiber type, color blends, and length affect pricing.</p>
    </div>
    <div class="card">
      <h3>3D Resin Accessories</h3>
      <p>💸 $10 – $75+</p>
      <p>Shoes, earrings, props, and custom pieces.</p>
    </div>
    <div class="card">
...
<section>
  <h2>🖤 Custom Request / Booking Form</h2>
